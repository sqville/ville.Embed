  ...
  members :
  {
    ...
    main : function()
    {
      ...
      var lblfluentuiheader = new qx.ui.basic.Label("Fluent UI Web Icons (SVG)").set({font: "control-header"});
       ...
       var embedfuiairplanetakeoffalone = new ville.embed.fluent.AirplaneTakeOffExample(40, "blue");
       ...
       var embedfuiairplanetakeoff = new ville.embed.fluent.AirplaneTakeOffExample(30, "blue");
