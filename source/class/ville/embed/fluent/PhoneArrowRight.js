...
qx.Class.define("ville.embed.fluent.PhoneArrowRight",
{
  ...
  */
  ...
  construct (size, color, iconstyle, title)
  {
   ...
   var pathdfilled = "M4 3.5C4 2.67 4.67 2 5.5 2h7c.83 0 1.5.67 1.5 1.5v5.52A5.5 5.5 0 0 0 9.02 14H7.5a.5.5 0 0 0 0 1h1.52c.1 1.13.55 2.17 1.24 3H5.5A1.5 1.5 0 0 1 4 16.5v-13ZM14.5 10a4.5 4.5 0 1 1 0 9 4.5 4.5 0 0 1 0-9Zm2.35 4.85a.5.5 0 0 0 .15-.35.5.5 0 0 0-.15-.35l-2-2a.5.5 0 0 0-.7.7L15.29 14H12.5a.5.5 0 0 0 0 1h2.8l-1.15 1.15a.5.5 0 0 0 .7.7l2-2Z";
