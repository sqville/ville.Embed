  ...
  */
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      // ville.GroupBox theme entries
      qx.Theme.include(qx.theme.manager.Appearance.getInstance().getTheme(), wax.demo.groupbox.Appearance);
      qx.Theme.include(qx.theme.manager.Decoration.getInstance().getTheme(), wax.demo.groupbox.Decoration);
      ...
      var atmtopfuiheader = new qx.ui.basic.Atom("Fluent UI Web Icons").set({font: "control-header"});
      var atmtopnavwebdemoheader = new qx.ui.basic.Atom("Wax Demo").set({appearance: "topnav-atom", anonymous: true, focusable: false, selectable: false });
      
      northtoolbar.add(atmtopnavwebdemoheader);
      northtoolbar.addSpacer();
      northtoolbar.add(atmtopfuiheader);
      northtoolbar.addSpacer();
      ...
      // Second page marker  
      var overviewscrollstackpage = new wax.demo.scroll.Scroll().set({padding: 0, margin: 0, contentPadding: [0,0,0,0]});
      ...
      var lblsubheadfuistart =  new qx.ui.basic.Label("Sources:").set({font: "headeratom", marginTop: 10});
       //simple description
       var lblfluentsimpledesc = new qx.ui.basic.Label("<b><a href='https://react.fluentui.dev/?path=/docs/icons-overview--default' target='_blank'>Microsoft's Fluent UI web icons</a></b> - Full list of available icons.").set({rich: true, wrap: true});
       var lblfluentsimpledesc2 = new qx.ui.basic.Label("<b><a href='https://github.com/microsoft/fluentui-system-icons/tree/main/packages/svg-icons' target='_blank'>SVG source</a></b> - SVG source project.").set({rich: true, wrap: true});
       ...
       var embedfuiairplanetakeoffalone = new ville.embed.fluent.AccessTime(40, "blue");
       var lblsimplefuiembedcode = new qx.ui.basic.Label("var <span style='color:green;'>fuiaccesstime</span> = <span style='color:blue;'>new</span> <span style='color:green;'>ville.embed.fluent.AccessTime</span>(40, \"blue\");").set({rich: true, wrap: true, font: "monospace", backgroundColor: "#f2f2f2", padding: 6});
       var lblsimplefuiembedcode2 = new qx.ui.basic.Label("Behind the scenes, the object's constructor sets initial values using - setWidth(size) setHeight(size) and setTextColor(color)");
       ...
       var embedfuiairplanetakeoff = new ville.embed.fluent.AccessTime(30, "blue");
       var btnembedfuiairplanebutton = new qx.ui.form.Button('Click Me').set({appearance: "testbutton-fui", embed: embedfuiairplanetakeoff, allowGrowX: false, padding: [10, 14], gap: 10, alignX: "left", alignY: "middle"});
       var lblbuttonfuiembedcode = new qx.ui.basic.Label("<span style='color:green;'>/* Include the Embed Mixin before creating the Button */</span><br>qx.Class.include(<span style='color:green;'>qx.ui.basic.Atom, ville.embed.MEmbed</span>);<br><span style='color:blue;'>new</span> <span style='color:green;'>qx.ui.form.Button(</span><span style='color:maroon;'>'Click Me'</span>).set({ embed : <span style='color:green;'>fuiaccesstime</span> });").set({rich: true, wrap: true, font: "monospace", backgroundColor: "#f2f2f2", padding: 6});
      ...
      //var lblsubheaderfuiFavs =  new qx.ui.basic.Label("Count: ").set({font: "headeratom", marginTop: 40});
      ...
      // php generated - All folder arrays
      var arrLTRembeds = []; 
      var arrRTLembeds = [];
      var arrarembeds = [];
      var arrbgembeds = [];
      ...
      // php generated - create objs and add to arrays
      var emdTextNumberListRotate270 = new ville.embed.fluent.LTR.TextNumberListRotate270(svgsize, null, null, "TextNumberListRotate270");
arrLTRembeds.push(emdTextNumberListRotate270);
var emdTextNumberListRotate90 = new ville.embed.fluent.LTR.TextNumberListRotate90(svgsize, null, null, "TextNumberListRotate90");
arrLTRembeds.push(emdTextNumberListRotate90);
var emdTextNumberListRotate270 = new ville.embed.fluent.RTL.TextNumberListRotate270(svgsize, null, null, "TextNumberListRotate270");
arrRTLembeds.push(emdTextNumberListRotate270);
var emdTextNumberListRotate90 = new ville.embed.fluent.RTL.TextNumberListRotate90(svgsize, null, null, "TextNumberListRotate90");
arrRTLembeds.push(emdTextNumberListRotate90);
...
// AR
var emdBookQuestionMark = new ville.embed.fluent.ar.BookQuestionMark(svgsize, null, null, "BookQuestionMark");
arrarembeds.push(emdBookQuestionMark);
var emdCommentNote = new ville.embed.fluent.ar.CommentNote(svgsize, null, null, "CommentNote");
arrarembeds.push(emdCommentNote);
var emdImageArrowBack = new ville.embed.fluent.ar.ImageArrowBack(svgsize, null, null, "ImageArrowBack");
arrarembeds.push(emdImageArrowBack);
var emdImageArrowForward = new ville.embed.fluent.ar.ImageArrowForward(svgsize, null, null, "ImageArrowForward");
arrarembeds.push(emdImageArrowForward);
// AR END
...
var emdTextBold = new ville.embed.fluent.bg.TextBold(svgsize, null, null, "TextBold");
arrbgembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.bg.TextItalic(svgsize, null, null, "TextItalic");
arrbgembeds.push(emdTextItalic);
var emdTextSortAscending = new ville.embed.fluent.bg.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrbgembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.bg.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrbgembeds.push(emdTextSortDescending);
var emdTextUnderline = new ville.embed.fluent.bg.TextUnderline(svgsize, null, null, "TextUnderline");
arrbgembeds.push(emdTextUnderline);
...
var emdTextBold = new ville.embed.fluent.ca.TextBold(svgsize, null, null, "TextBold");
arrcaembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.ca.TextItalic(svgsize, null, null, "TextItalic");
arrcaembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.ca.TextUnderline(svgsize, null, null, "TextUnderline");
arrcaembeds.push(emdTextUnderline);
...
var emdTextBold = new ville.embed.fluent.da.TextBold(svgsize, null, null, "TextBold");
arrdaembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.da.TextItalic(svgsize, null, null, "TextItalic");
arrdaembeds.push(emdTextItalic);
var emdTextSortAscending = new ville.embed.fluent.da.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrdaembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.da.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrdaembeds.push(emdTextSortDescending);
...
var emdTextBold = new ville.embed.fluent.de.TextBold(svgsize, null, null, "TextBold");
arrdeembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.de.TextItalic(svgsize, null, null, "TextItalic");
arrdeembeds.push(emdTextItalic);
...
// EN
var emdLocalLanguage = new ville.embed.fluent.en.LocalLanguage(svgsize, null, null, "LocalLanguage");
arrenembeds.push(emdLocalLanguage);
var emdTextBold = new ville.embed.fluent.en.TextBold(svgsize, null, null, "TextBold");
arrenembeds.push(emdTextBold);
var emdTextClearFormatting = new ville.embed.fluent.en.TextClearFormatting(svgsize, null, null, "TextClearFormatting");
arrenembeds.push(emdTextClearFormatting);
var emdTextColor = new ville.embed.fluent.en.TextColor(svgsize, null, null, "TextColor");
arrenembeds.push(emdTextColor);
var emdTextDirectionHorizontalLeft = new ville.embed.fluent.en.TextDirectionHorizontalLeft(svgsize, null, null, "TextDirectionHorizontalLeft");
arrenembeds.push(emdTextDirectionHorizontalLeft);
var emdTextDirectionHorizontalLtr = new ville.embed.fluent.en.TextDirectionHorizontalLtr(svgsize, null, null, "TextDirectionHorizontalLtr");
arrenembeds.push(emdTextDirectionHorizontalLtr);
var emdTextDirectionHorizontalRight = new ville.embed.fluent.en.TextDirectionHorizontalRight(svgsize, null, null, "TextDirectionHorizontalRight");
arrenembeds.push(emdTextDirectionHorizontalRight);
var emdTextDirectionHorizontalRtl = new ville.embed.fluent.en.TextDirectionHorizontalRtl(svgsize, null, null, "TextDirectionHorizontalRtl");
arrenembeds.push(emdTextDirectionHorizontalRtl);
var emdTextDirectionRotate270Right = new ville.embed.fluent.en.TextDirectionRotate270Right(svgsize, null, null, "TextDirectionRotate270Right");
arrenembeds.push(emdTextDirectionRotate270Right);
var emdTextDirectionRotate90Left = new ville.embed.fluent.en.TextDirectionRotate90Left(svgsize, null, null, "TextDirectionRotate90Left");
arrenembeds.push(emdTextDirectionRotate90Left);
var emdTextDirectionRotate90Ltr = new ville.embed.fluent.en.TextDirectionRotate90Ltr(svgsize, null, null, "TextDirectionRotate90Ltr");
arrenembeds.push(emdTextDirectionRotate90Ltr);
var emdTextDirectionRotate90Right = new ville.embed.fluent.en.TextDirectionRotate90Right(svgsize, null, null, "TextDirectionRotate90Right");
arrenembeds.push(emdTextDirectionRotate90Right);
var emdTextDirectionRotate90Rtl = new ville.embed.fluent.en.TextDirectionRotate90Rtl(svgsize, null, null, "TextDirectionRotate90Rtl");
arrenembeds.push(emdTextDirectionRotate90Rtl);
var emdTextDirectionVertical = new ville.embed.fluent.en.TextDirectionVertical(svgsize, null, null, "TextDirectionVertical");
arrenembeds.push(emdTextDirectionVertical);
var emdTextEditStyle = new ville.embed.fluent.en.TextEditStyle(svgsize, null, null, "TextEditStyle");
arrenembeds.push(emdTextEditStyle);
var emdTextEffects = new ville.embed.fluent.en.TextEffects(svgsize, null, null, "TextEffects");
arrenembeds.push(emdTextEffects);
var emdTextFootnote = new ville.embed.fluent.en.TextFootnote(svgsize, null, null, "TextFootnote");
arrenembeds.push(emdTextFootnote);
var emdTextItalic = new ville.embed.fluent.en.TextItalic(svgsize, null, null, "TextItalic");
arrenembeds.push(emdTextItalic);
var emdTextMore = new ville.embed.fluent.en.TextMore(svgsize, null, null, "TextMore");
arrenembeds.push(emdTextMore);
var emdTextNumberFormat = new ville.embed.fluent.en.TextNumberFormat(svgsize, null, null, "TextNumberFormat");
arrenembeds.push(emdTextNumberFormat);
var emdTextParagraph = new ville.embed.fluent.en.TextParagraph(svgsize, null, null, "TextParagraph");
arrenembeds.push(emdTextParagraph);
var emdTextProofingTools = new ville.embed.fluent.en.TextProofingTools(svgsize, null, null, "TextProofingTools");
arrenembeds.push(emdTextProofingTools);
var emdTextSortAscending = new ville.embed.fluent.en.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrenembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.en.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrenembeds.push(emdTextSortDescending);
var emdTextStrikethrough = new ville.embed.fluent.en.TextStrikethrough(svgsize, null, null, "TextStrikethrough");
arrenembeds.push(emdTextStrikethrough);
var emdTextUnderline = new ville.embed.fluent.en.TextUnderline(svgsize, null, null, "TextUnderline");
arrenembeds.push(emdTextUnderline);
// EN END

// HE
var emdCommentNote = new ville.embed.fluent.he.CommentNote(svgsize, null, null, "CommentNote");
arrheembeds.push(emdCommentNote);
var emdImageArrowBack = new ville.embed.fluent.he.ImageArrowBack(svgsize, null, null, "ImageArrowBack");
arrheembeds.push(emdImageArrowBack);
var emdImageArrowForward = new ville.embed.fluent.he.ImageArrowForward(svgsize, null, null, "ImageArrowForward");
arrheembeds.push(emdImageArrowForward);
...
var emdTextBold = new ville.embed.fluent.es.TextBold(svgsize, null, null, "TextBold");
arresembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.es.TextItalic(svgsize, null, null, "TextItalic");
arresembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.es.TextUnderline(svgsize, null, null, "TextUnderline");
arresembeds.push(emdTextUnderline);
var emdTextBold = new ville.embed.fluent.et.TextBold(svgsize, null, null, "TextBold");
arretembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.et.TextItalic(svgsize, null, null, "TextItalic");
arretembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.et.TextUnderline(svgsize, null, null, "TextUnderline");
arretembeds.push(emdTextUnderline);
var emdTextItalic = new ville.embed.fluent.eu.TextItalic(svgsize, null, null, "TextItalic");
arreuembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.eu.TextUnderline(svgsize, null, null, "TextUnderline");
arreuembeds.push(emdTextUnderline);
...
var emdTextSortAscending = new ville.embed.fluent.fi.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrfiembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.fi.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrfiembeds.push(emdTextSortDescending);
...
var emdTextBold = new ville.embed.fluent.fr.TextBold(svgsize, null, null, "TextBold");
arrfrembeds.push(emdTextBold);
var emdTextUnderline = new ville.embed.fluent.fr.TextUnderline(svgsize, null, null, "TextUnderline");
arrfrembeds.push(emdTextUnderline);
...
var emdTextBold = new ville.embed.fluent.gl.TextBold(svgsize, null, null, "TextBold");
arrglembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.gl.TextItalic(svgsize, null, null, "TextItalic");
arrglembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.gl.TextUnderline(svgsize, null, null, "TextUnderline");
arrglembeds.push(emdTextUnderline);
...
var emdTextSortAscending = new ville.embed.fluent.gr.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrgrembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.gr.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrgrembeds.push(emdTextSortDescending);
...
var emdTextBold = new ville.embed.fluent.hu.TextBold(svgsize, null, null, "TextBold");
arrhuembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.hu.TextItalic(svgsize, null, null, "TextItalic");
arrhuembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.hu.TextUnderline(svgsize, null, null, "TextUnderline");
arrhuembeds.push(emdTextUnderline);
...
var emdTextBold = new ville.embed.fluent.it.TextBold(svgsize, null, null, "TextBold");
arritembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.it.TextItalic(svgsize, null, null, "TextItalic");
arritembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.it.TextUnderline(svgsize, null, null, "TextUnderline");
arritembeds.push(emdTextUnderline);
var emdLocalLanguage = new ville.embed.fluent.ja.LocalLanguage(svgsize, null, null, "LocalLanguage");
arrjaembeds.push(emdLocalLanguage);
var emdTextParagraph = new ville.embed.fluent.ja.TextParagraph(svgsize, null, null, "TextParagraph");
arrjaembeds.push(emdTextParagraph);
...
var emdTextBold = new ville.embed.fluent.kk.TextBold(svgsize, null, null, "TextBold");
arrkkembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.kk.TextItalic(svgsize, null, null, "TextItalic");
arrkkembeds.push(emdTextItalic);
var emdTextSortAscending = new ville.embed.fluent.kk.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrkkembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.kk.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrkkembeds.push(emdTextSortDescending);
var emdTextUnderline = new ville.embed.fluent.kk.TextUnderline(svgsize, null, null, "TextUnderline");
arrkkembeds.push(emdTextUnderline);
var emdLocalLanguage = new ville.embed.fluent.ko.LocalLanguage(svgsize, null, null, "LocalLanguage");
arrkoembeds.push(emdLocalLanguage);
var emdTextBold = new ville.embed.fluent.ko.TextBold(svgsize, null, null, "TextBold");
arrkoembeds.push(emdTextBold);
var emdTextColor = new ville.embed.fluent.ko.TextColor(svgsize, null, null, "TextColor");
arrkoembeds.push(emdTextColor);
var emdTextDirectionHorizontalLeft = new ville.embed.fluent.ko.TextDirectionHorizontalLeft(svgsize, null, null, "TextDirectionHorizontalLeft");
arrkoembeds.push(emdTextDirectionHorizontalLeft);
var emdTextDirectionHorizontalLtr = new ville.embed.fluent.ko.TextDirectionHorizontalLtr(svgsize, null, null, "TextDirectionHorizontalLtr");
arrkoembeds.push(emdTextDirectionHorizontalLtr);
var emdTextDirectionHorizontalRight = new ville.embed.fluent.ko.TextDirectionHorizontalRight(svgsize, null, null, "TextDirectionHorizontalRight");
arrkoembeds.push(emdTextDirectionHorizontalRight);
var emdTextDirectionHorizontalRtl = new ville.embed.fluent.ko.TextDirectionHorizontalRtl(svgsize, null, null, "TextDirectionHorizontalRtl");
arrkoembeds.push(emdTextDirectionHorizontalRtl);
var emdTextDirectionRotate270Right = new ville.embed.fluent.ko.TextDirectionRotate270Right(svgsize, null, null, "TextDirectionRotate270Right");
arrkoembeds.push(emdTextDirectionRotate270Right);
var emdTextDirectionRotate90Ltr = new ville.embed.fluent.ko.TextDirectionRotate90Ltr(svgsize, null, null, "TextDirectionRotate90Ltr");
arrkoembeds.push(emdTextDirectionRotate90Ltr);
var emdTextDirectionRotate90Right = new ville.embed.fluent.ko.TextDirectionRotate90Right(svgsize, null, null, "TextDirectionRotate90Right");
arrkoembeds.push(emdTextDirectionRotate90Right);
var emdTextDirectionVertical = new ville.embed.fluent.ko.TextDirectionVertical(svgsize, null, null, "TextDirectionVertical");
arrkoembeds.push(emdTextDirectionVertical);
var emdTextEditStyle = new ville.embed.fluent.ko.TextEditStyle(svgsize, null, null, "TextEditStyle");
arrkoembeds.push(emdTextEditStyle);
var emdTextEffects = new ville.embed.fluent.ko.TextEffects(svgsize, null, null, "TextEffects");
arrkoembeds.push(emdTextEffects);
var emdTextFootnote = new ville.embed.fluent.ko.TextFootnote(svgsize, null, null, "TextFootnote");
arrkoembeds.push(emdTextFootnote);
var emdTextItalic = new ville.embed.fluent.ko.TextItalic(svgsize, null, null, "TextItalic");
arrkoembeds.push(emdTextItalic);
var emdTextMore = new ville.embed.fluent.ko.TextMore(svgsize, null, null, "TextMore");
arrkoembeds.push(emdTextMore);
var emdTextNumberFormat = new ville.embed.fluent.ko.TextNumberFormat(svgsize, null, null, "TextNumberFormat");
arrkoembeds.push(emdTextNumberFormat);
var emdTextParagraph = new ville.embed.fluent.ko.TextParagraph(svgsize, null, null, "TextParagraph");
arrkoembeds.push(emdTextParagraph);
var emdTextProofingTools = new ville.embed.fluent.ko.TextProofingTools(svgsize, null, null, "TextProofingTools");
arrkoembeds.push(emdTextProofingTools);
var emdTextSortAscending = new ville.embed.fluent.ko.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrkoembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.ko.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrkoembeds.push(emdTextSortDescending);
var emdTextStrikethrough = new ville.embed.fluent.ko.TextStrikethrough(svgsize, null, null, "TextStrikethrough");
arrkoembeds.push(emdTextStrikethrough);
var emdTextUnderline = new ville.embed.fluent.ko.TextUnderline(svgsize, null, null, "TextUnderline");
arrkoembeds.push(emdTextUnderline);
...
var emdTextBold = new ville.embed.fluent.lt.TextBold(svgsize, null, null, "TextBold");
arrltembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.lt.TextItalic(svgsize, null, null, "TextItalic");
arrltembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.lt.TextUnderline(svgsize, null, null, "TextUnderline");
arrltembeds.push(emdTextUnderline);
var emdLuggage = new ville.embed.fluent.Luggage(svgsize, null, null, "Luggage");
arrembeds.push(emdLuggage);
var emdTextBold = new ville.embed.fluent.lv.TextBold(svgsize, null, null, "TextBold");
arrlvembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.lv.TextItalic(svgsize, null, null, "TextItalic");
arrlvembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.lv.TextUnderline(svgsize, null, null, "TextUnderline");
arrlvembeds.push(emdTextUnderline);
...
var emdTextBold = new ville.embed.fluent.ms.TextBold(svgsize, null, null, "TextBold");
arrmsembeds.push(emdTextBold);
...
var emdTextBold = new ville.embed.fluent.no.TextBold(svgsize, null, null, "TextBold");
arrnoembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.no.TextItalic(svgsize, null, null, "TextItalic");
arrnoembeds.push(emdTextItalic);
...
var emdTextBold = new ville.embed.fluent.pt.TextBold(svgsize, null, null, "TextBold");
arrptembeds.push(emdTextBold);
var emdTextUnderline = new ville.embed.fluent.pt.TextUnderline(svgsize, null, null, "TextUnderline");
arrptembeds.push(emdTextUnderline);
...
var emdTextBold = new ville.embed.fluent.ru.TextBold(svgsize, null, null, "TextBold");
arrruembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.ru.TextItalic(svgsize, null, null, "TextItalic");
arrruembeds.push(emdTextItalic);
var emdTextSortAscending = new ville.embed.fluent.ru.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrruembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.ru.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrruembeds.push(emdTextSortDescending);
var emdTextUnderline = new ville.embed.fluent.ru.TextUnderline(svgsize, null, null, "TextUnderline");
arrruembeds.push(emdTextUnderline);
...
var emdTextSortAscending = new ville.embed.fluent.se.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrseembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.se.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrseembeds.push(emdTextSortDescending);
...
var emdTextBold = new ville.embed.fluent.sl.TextBold(svgsize, null, null, "TextBold");
arrslembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.sl.TextItalic(svgsize, null, null, "TextItalic");
arrslembeds.push(emdTextItalic);
var emdTextSortAscending = new ville.embed.fluent.sl.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrslembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.sl.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrslembeds.push(emdTextSortDescending);
var emdTextUnderline = new ville.embed.fluent.sl.TextUnderline(svgsize, null, null, "TextUnderline");
arrslembeds.push(emdTextUnderline);
...
var emdTextItalic = new ville.embed.fluent.sr.TextItalic(svgsize, null, null, "TextItalic");
arrsrembeds.push(emdTextItalic);
var emdTextSortAscending = new ville.embed.fluent.sr.TextSortAscending(svgsize, null, null, "TextSortAscending");
arrsrembeds.push(emdTextSortAscending);
var emdTextSortDescending = new ville.embed.fluent.sr.TextSortDescending(svgsize, null, null, "TextSortDescending");
arrsrembeds.push(emdTextSortDescending);
var emdTextUnderline = new ville.embed.fluent.sr.TextUnderline(svgsize, null, null, "TextUnderline");
arrsrembeds.push(emdTextUnderline);
var emdTextBold = new ville.embed.fluent.srcyrl.TextBold(svgsize, null, null, "TextBold");
arrsrcyrlembeds.push(emdTextBold);
var emdTextBold = new ville.embed.fluent.srlatn.TextBold(svgsize, null, null, "TextBold");
arrsrlatnembeds.push(emdTextBold);
...
var emdTextBold = new ville.embed.fluent.sv.TextBold(svgsize, null, null, "TextBold");
arrsvembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.sv.TextItalic(svgsize, null, null, "TextItalic");
arrsvembeds.push(emdTextItalic);
...
var emdTextBold = new ville.embed.fluent.tr.TextBold(svgsize, null, null, "TextBold");
arrtrembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.tr.TextItalic(svgsize, null, null, "TextItalic");
arrtrembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.tr.TextUnderline(svgsize, null, null, "TextUnderline");
arrtrembeds.push(emdTextUnderline);
...
var emdTextBold = new ville.embed.fluent.uk.TextBold(svgsize, null, null, "TextBold");
arrukembeds.push(emdTextBold);
var emdTextItalic = new ville.embed.fluent.uk.TextItalic(svgsize, null, null, "TextItalic");
arrukembeds.push(emdTextItalic);
var emdTextUnderline = new ville.embed.fluent.uk.TextUnderline(svgsize, null, null, "TextUnderline");
arrukembeds.push(emdTextUnderline);
...
var emdLocalLanguage = new ville.embed.fluent.zh.LocalLanguage(svgsize, null, null, "LocalLanguage");
arrzhembeds.push(emdLocalLanguage);
var emdTextParagraph = new ville.embed.fluent.zh.TextParagraph(svgsize, null, null, "TextParagraph");
arrzhembeds.push(emdTextParagraph);
var emdTextProofingTools = new ville.embed.fluent.zh.TextProofingTools(svgsize, null, null, "TextProofingTools");
arrzhembeds.push(emdTextProofingTools);
...
arrembeds.push(emdZoomOut);
    ...
    // php generated - create groupboxes
    var LTRgb = new wax.demo.groupbox.GroupBox("LTR", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    LTRgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrLTRembeds.forEach((embed) => {
    ...
    fuiiconflow.add(LTRgb);

    var RTLgb = new wax.demo.groupbox.GroupBox("RTL", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    RTLgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrRTLembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      RTLgb.add(atmembed);
    });
    fuiiconflow.add(RTLgb);

    var argb = new wax.demo.groupbox.GroupBox("ar", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    argb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrarembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      argb.add(atmembed);
    });
    fuiiconflow.add(argb, {lineBreak: true, stretch: true});

    var bggb = new wax.demo.groupbox.GroupBox("bg", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    bggb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrbgembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    bggb.add(atmembed);
    });
    fuiiconflow.add(bggb, {lineBreak: true, stretch: true});

    var cagb = new wax.demo.groupbox.GroupBox("ca", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    cagb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrcaembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      cagb.add(atmembed);
    });
    fuiiconflow.add(cagb);

    var dagb = new wax.demo.groupbox.GroupBox("da", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    dagb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrdaembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      dagb.add(atmembed);
    });
    fuiiconflow.add(dagb, {lineBreak: true, stretch: true});

    var degb = new wax.demo.groupbox.GroupBox("de", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    degb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrdeembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      degb.add(atmembed);
    });
    fuiiconflow.add(degb, {lineBreak: true});

    var engb = new wax.demo.groupbox.GroupBox("en", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    engb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrenembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      engb.add(atmembed);
    });
    fuiiconflow.add(engb, {lineBreak: true, stretch: true});

    var esgb = new wax.demo.groupbox.GroupBox("es", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    esgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arresembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    esgb.add(atmembed);
    });
    fuiiconflow.add(esgb);
    var etgb = new wax.demo.groupbox.GroupBox("et", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    etgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arretembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    etgb.add(atmembed);
    });
    fuiiconflow.add(etgb);
    var eugb = new wax.demo.groupbox.GroupBox("eu", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    eugb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arreuembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    eugb.add(atmembed);
    });
    fuiiconflow.add(eugb);
    var figb = new wax.demo.groupbox.GroupBox("fi", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    figb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrfiembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    figb.add(atmembed);
    });
    fuiiconflow.add(figb);
    var frgb = new wax.demo.groupbox.GroupBox("fr", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    frgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrfrembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    frgb.add(atmembed);
    });
    fuiiconflow.add(frgb);
    var glgb = new wax.demo.groupbox.GroupBox("gl", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    glgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrglembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    glgb.add(atmembed);
    });
    fuiiconflow.add(glgb);
    var grgb = new wax.demo.groupbox.GroupBox("gr", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    grgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrgrembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    grgb.add(atmembed);
    });
    fuiiconflow.add(grgb);

    var hegb = new wax.demo.groupbox.GroupBox("he", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    hegb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrheembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      hegb.add(atmembed);
    });
    fuiiconflow.add(hegb, {lineBreak: true, stretch: true});

    var hugb = new wax.demo.groupbox.GroupBox("hu", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    hugb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrhuembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    hugb.add(atmembed);
    });
    fuiiconflow.add(hugb);
    var itgb = new wax.demo.groupbox.GroupBox("it", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    itgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arritembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    itgb.add(atmembed);
    });
    fuiiconflow.add(itgb);
    var jagb = new wax.demo.groupbox.GroupBox("ja", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    jagb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrjaembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    jagb.add(atmembed);
    });
    fuiiconflow.add(jagb);

    var kkgb = new wax.demo.groupbox.GroupBox("kk", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    kkgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrkkembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      kkgb.add(atmembed);
    });
    fuiiconflow.add(kkgb, {lineBreak: true, stretch: true});

    var kogb = new wax.demo.groupbox.GroupBox("ko", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    kogb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrkoembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      kogb.add(atmembed);
    });
    fuiiconflow.add(kogb, {lineBreak: true, stretch: true});

    var ltgb = new wax.demo.groupbox.GroupBox("lt", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    ltgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrltembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    ltgb.add(atmembed);
    });
    fuiiconflow.add(ltgb);
    var lvgb = new wax.demo.groupbox.GroupBox("lv", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    lvgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrlvembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    lvgb.add(atmembed);
    });
    fuiiconflow.add(lvgb);
    var msgb = new wax.demo.groupbox.GroupBox("ms", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    msgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrmsembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    msgb.add(atmembed);
    });
    fuiiconflow.add(msgb);
    var nogb = new wax.demo.groupbox.GroupBox("no", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    nogb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrnoembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    nogb.add(atmembed);
    });
    fuiiconflow.add(nogb);
    var ptgb = new wax.demo.groupbox.GroupBox("pt", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    ptgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrptembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    ptgb.add(atmembed);
    ...
    fuiiconflow.add(ptgb);
    var rugb = new wax.demo.groupbox.GroupBox("ru", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    rugb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrruembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      rugb.add(atmembed);
    });
    fuiiconflow.add(rugb, {lineBreak: true, stretch: true});

    var segb = new wax.demo.groupbox.GroupBox("se", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    segb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrseembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    segb.add(atmembed);
    });
    fuiiconflow.add(segb);

    var slgb = new wax.demo.groupbox.GroupBox("sl", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    slgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrslembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      slgb.add(atmembed);
    });
    fuiiconflow.add(slgb, {lineBreak: true, stretch: true});

    var srgb = new wax.demo.groupbox.GroupBox("sr", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    srgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrsrembeds.forEach((embed) => {
      var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
      var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
      atmembed.setEmbed(embed);
      srgb.add(atmembed);
    });
    fuiiconflow.add(srgb, {lineBreak: true, stretch: true});

    var srcyrlgb = new wax.demo.groupbox.GroupBox("srcyrl", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    srcyrlgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrsrcyrlembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    srcyrlgb.add(atmembed);
    });
    fuiiconflow.add(srcyrlgb);
    var srlatngb = new wax.demo.groupbox.GroupBox("srlatn", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    srlatngb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrsrlatnembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    srlatngb.add(atmembed);
    });
    fuiiconflow.add(srlatngb);
    var svgb = new wax.demo.groupbox.GroupBox("sv", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    svgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrsvembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    svgb.add(atmembed);
    });
    fuiiconflow.add(svgb);
    var trgb = new wax.demo.groupbox.GroupBox("tr", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    trgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrtrembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    trgb.add(atmembed);
    });
    fuiiconflow.add(trgb);
    var ukgb = new wax.demo.groupbox.GroupBox("uk", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    ukgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrukembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    ukgb.add(atmembed);
    });
    fuiiconflow.add(ukgb);
    var zhgb = new wax.demo.groupbox.GroupBox("zh", null, true, true, false).set({appearance: "ville-groupbox-connected", allowShrinkX: true, allowShrinkY: true, allowGrowX: true, allowGrowY: true});
    zhgb.setLayout(new qx.ui.layout.Flow(6,6,"left"));
    arrzhembeds.forEach((embed) => {
    var atmlabel = embed.getTitle().replace("<title>","").replace("</title>","");
    var atmembed = new qx.ui.basic.Atom(atmlabel).set(atmprops);
    atmembed.setEmbed(embed);
    zhgb.add(atmembed);
    });
    fuiiconflow.add(zhgb);
      ...
      var lblsubheaderfuicount = new qx.ui.basic.Label("Count: 2,619").set({marginTop: 30, font: "headeratom", alignX: "left", alignY: "middle"});
      
      overviewpage.add(lblsubheadfuistart);     
      overviewpage.add(lblfluentsimpledesc); 
      overviewpage.add(lblfluentsimpledesc2);
      ...
      overviewpage.add(lblsimplefuiembedcode2);
      ...
      overviewpage.add(lblsubheaderfuicount);
