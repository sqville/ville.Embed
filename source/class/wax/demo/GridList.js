...
/**
 * A list of items in a grid layout
 */
qx.Class.define("wax.demo.GridList", {
  extend: wax.demo.scroll.AbstractScrollArea,
  implement: [
  ...
  */
  ...
  properties: {
     ...
     */
    orientation: {
      check: ["grid", "horizontal", "vertical"],
      init: "grid",
  ...
  members: {
    ...
    */
    ...
    _applyOrientation(value, old) {
      ...
      switch (value) {
        case "grid":
          ...
          break;
        case "horizontal":
          content.setLayout(new qx.ui.layout.HBox());
    ...
    _applySpacing(value, old) {
      ...
      this.__content.getLayout().setSpacingX(value);
      this.__content.getLayout().setSpacingY(value);
    },
